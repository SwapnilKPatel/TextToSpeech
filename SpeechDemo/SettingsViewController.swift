...
//  SpeechDemo
//
//  Created by Swapnil Patel on 22/10/19.
...
protocol SettingsViewControllerDelegate {
    func didSaveSettings(rate : Float, pitch : Float, volume : Float)
}
...
class SettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        selectedVoiceLanguage = UserDefaults.standard.value(forKey: "languageInx") as! Int
        prepareVoiceList()
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row < 3 {
            ...
            pickerView = cell.contentView.viewWithTag(10) as? UIPickerView
            pickerView?.delegate = self
            pickerView?.dataSource = self
            if let indx =  UserDefaults.standard.value(forKey: "languageInx") {
                pickerView?.selectRow(indx as! Int, inComponent: 0, animated: false)
            }
   ...
   func tableView(_ tableView: UITableView, heightForRowAt indexPath: IndexPath) -> CGFloat {
    ...
    @IBAction func saveSettings(sender: AnyObject) {
        ...
        UserDefaults.standard.set(arrVoiceLanguages[selectedVoiceLanguage]["languageCode"] as Any?, forKey: "languageCode")
        UserDefaults.standard.set(selectedVoiceLanguage, forKey: "languageInx")
        UserDefaults.standard.synchronize()
        
    //    self.delegate.didSaveSettings(rate: rate, pitch: pitch,volume: volume)
    ...
    // MARK: Custom method implementation
     ...
     @IBAction func handleSliderValueChange(sender: CustomSlider) {
    ...
    func prepareVoiceList() {
        for voice in AVSpeechSynthesisVoice.speechVoices() {
            ...
            let languageName = Locale.current.localizedString(forLanguageCode: voiceLanguageCode)
          // let languageName = Locale.current.displayNameForKey(NSLocaleIdentifier, value: voiceLanguageCode)
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        ...
        title = voiceLanguagesDictionary["languageName"]!
